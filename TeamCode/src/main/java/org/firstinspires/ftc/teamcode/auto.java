...
//        if(cub[1]!=1){
//            drive.followTrajectory(pos1);
//            drive.gear_rack.setPosition(gear[cub[1]]);
//            //angle
//            drive.followTrajectory(pos0);
//            //angle
//            drive.gear_rack.setPosition(1);
//            if(cub[2]==1){
//                drive.followTrajectory(pos2);
//                drive.gear_rack.setPosition(gear[1]);
//                drive.followTrajectory(pos1);
//                drive.gear_rack.setPosition(1);
//                drive.followTrajectory(pos0);
//                drive.gear_rack.setPosition(gear[cub[1]]);
...
//        if(cub[2]!=2){
//                drive.followTrajectory(pos2);
//                drive.gear_rack.setPosition(gear[3]);
//                drive.followTrajectory(pos0);
//                drive.gear_rack.setPosition(1);
//                drive.followTrajectory(pos3);
//                drive.gear_rack.setPosition(gear[2]);
//                drive.followTrajectory(pos2);
//                drive.gear_rack.setPosition(1);
//                drive.followTrajectory(pos0);
//                drive.gear_rack.setPosition(gear[3]);
